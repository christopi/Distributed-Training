...
class DatasetCatalog:
    def __init__(self):
        ...
        self.audiocap_enc = {
            "target": "transverse.multimodal.dataset.audiocap_dataset.AudioCapDataset",
            "params": dict(
        ...
        self.webvid_enc = {
            "target": "transverse.multimodal.dataset.webvid_dataset.WebvidDataset",
            "params": dict(
        ...
        self.cc3m_enc = {
            "target": "transverse.multimodal.dataset.cc3m_dataset.CC3MDataset",
            "params": dict(
